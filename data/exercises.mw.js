// Auto-generated (Fallback With Real Video Links)
...
export const BADMINTON_WARMUP_MW = [
  {
    "id": "high-knees",
    "stepType": "warmup",
    "focus": "general",
  ...
  },
  {
    ...
    "duration": "40秒/侧",
    "tips": [
      "单腿站立，支撑腿膝盖微微弯曲（极佳的膝关节稳定训练）",
      "另一只脚分别向正前、侧面、正后方轻触地面，核心全程收紧"
    ],
    "mistakes": [
      "支撑腿膝盖内扣",
      "重心不稳晃动过大"
...
export const BADMINTON_COOLDOWN_MW = [
  {
    "id": "calf-stretch",
    "stepType": "cooldown",
    "focus": "legs",
